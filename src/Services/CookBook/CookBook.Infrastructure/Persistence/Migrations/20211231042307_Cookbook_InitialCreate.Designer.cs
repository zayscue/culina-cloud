...
namespace CulinaCloud.CookBook.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20211231042307_Cookbook_InitialCreate")]
    partial class Cookbook_InitialCreate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.Recipe", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeImage", b =>
                {
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeIngredient", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("RecipeId");
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeMetadata", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("RecipeId");
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeNutrition", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("RecipeId");
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeStep", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("RecipeId");
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeTag", b =>
                {
                    b.Property<Guid>("RecipeId")
                        .HasColumnType("uuid")
                        .HasColumnName("RecipeId");
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeImage", b =>
                {
                    b.HasOne("CulinaCloud.CookBook.Domain.Entities.Image", "Image")
                        .WithMany("RecipeImages")
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CulinaCloud.CookBook.Domain.Entities.Recipe", "Recipe")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeIngredient", b =>
                {
                    b.HasOne("CulinaCloud.CookBook.Domain.Entities.Ingredient", "Ingredient")
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeNutrition", b =>
                {
                    b.HasOne("CulinaCloud.CookBook.Domain.Entities.Recipe", "Recipe")
                        .WithOne("Nutrition")
                        .HasForeignKey("CulinaCloud.CookBook.Domain.Entities.RecipeNutrition", "RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CulinaCloud.CookBook.Domain.Entities.RecipeTag", b =>
                {
                    ...
                    b.HasOne("CulinaCloud.CookBook.Domain.Entities.Tag", "Tag")
                        .WithMany("RecipeTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
